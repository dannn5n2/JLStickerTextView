...
extension JLStickerLabelView: UITextViewDelegate {
    ...
    public func textViewDidChange(_ textView: UITextView) {
        if textView.text != "" {
            adjustsWidthToFillItsContens(self, labelView: labelTextView)
            labelTextView.attributedText = NSAttributedString(string: labelTextView.text, attributes: convertToOptionalNSAttributedStringKeyDictionary(labelTextView.textAttributes))
